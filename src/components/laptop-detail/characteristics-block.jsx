            ...
            <div className={""}>
                ...
                <div className={"flex mb-2"}>
                    ...
                    {isEditing ?
                        (<Input
                            ...
                            size={"small"}/>) : <p>{laptop.serviceTag}</p>
                    }
                </div>
                <div className={"flex mb-2"}>
                    ...
                    {isEditing ? <Input
                        ...
                        size={"small"}/> : <p>{laptop.characteristics?.processor}</p>}
                </div>
                <div className={"flex mb-2"}>
                    ...
                    <div className={"flex flex-col w-2/3 "}>
                        {isEditing ? <Input
                            ...
                            size={"small"}/> : <p>{laptop.characteristics?.videocard}</p>}

                        <Checkbox className={""} defaultChecked={laptop.characteristics?.discrete} disabled={!isEditing}
                                  onChange={(e) => laptop.characteristics.discrete = e.target.checked}>Discrete</Checkbox>
                        <Checkbox className={""} defaultChecked={laptop.characteristics?.keyLight} disabled={!isEditing}
                                  onChange={(e) => laptop.characteristics.keyLight = e.target.checked}>Підсвітка
                            клави</Checkbox>
                    </div>
                </div>
                <div className={"flex mb-2"}>
                ...
                <div className={"flex mb-2"}>
                    ...
                    <div className={"flex flex-col w-2/3 "}>
                        ...
                        <Checkbox className={""} defaultChecked={laptop.characteristics?.touch} disabled={!isEditing}
                                  onChange={(e) => laptop.characteristics.touch = e.target.checked}>Touch</Checkbox>
                    </div>
                </div>
                <div className={"flex mb-2"}>
