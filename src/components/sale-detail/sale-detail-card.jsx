      ...
      <div className={"flex flex-col gap-2"}>
        ...
        <div className={"flex items-center"}>
          ...
          {isEditing ? (
            ...
            <Typography.Text className={"w-2/3 text-gray-800"}>
              {SaleManager.getSourceListOptions().find((opt) => opt.value === sale.source)?.label || "-"}
            </Typography.Text>
          )}
        </div>
        <div className={"flex items-center"}>
          ...
          {isEditing ? (
            ...
            <Typography.Text className={"w-2/3 text-gray-800"}>
              {SaleManager.getDeliveryTypeListOptions().find((opt) => opt.value === sale.deliveryType)?.label || "-"}
            </Typography.Text>
          )}
        </div>
        <div className={"flex items-center"}>
