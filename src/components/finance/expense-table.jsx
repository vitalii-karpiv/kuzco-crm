  ...
  const columns = [
    ...
    },
    {
      ...
      render: (orderId) => {
        ...
        if (!order) return <p>—</p>;
        return (
          <div className={"whitespace-nowrap overflow-hidden scroll-auto"}>
            <Typography.Text code>{order?.code}</Typography.Text> {order?.name}
          </div>
        );
      },
    },
    ...
    <div className={"flex justify-between align-middle"}>
      ...
      <div>
        <Button
          ...
          className={"mr-2 bg-sky-400 text-white"}
