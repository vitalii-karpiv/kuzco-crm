...
export default function RevenueEarnCard() {
    ...
    return (
        <Card className={"mb-2"} loading={loading} bordered={false} hoverable={true}>
            <div>
                <div className={"flex"}>
                    <Typography.Title level={4} className={"mb-0"}>Revenue & Earnings</Typography.Title>
                    <RangePicker
                        value={range}
                ...
                <div className={"mt-2"}>
                    <div className={"flex"}>
                        <div
                            className={"bg-pink-100 p-2 rounded mr-2"}>Revenue: {revenue !== null ? prettifyNumber(revenue) : '-'} UAH
                        </div>
                        <div className={"bg-fuchsia-100 p-2 rounded"}>Earn
                            (net): {earn !== null ? prettifyNumber(earn) : '-'} UAH
                        </div>
                    </div>
                </div>
            </div>
